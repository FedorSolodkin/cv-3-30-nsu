...
def draw_boxes_and_save(image, boxes, confidences, scale_factors, output_path="cv3-03/cv-3-03/res/east_result.jpg"):
    """
    ...
    output_path : str, optional
        Путь для сохранения результата (по умолчанию "cv3-03/cv-3-03/res/east_result.jpg")
...
def main():
    ...
    try:
        ...
        EAST_MODEL_PATH = "C:\\cv3-03\\cw-2-35\\models\\frozen_east_text_detection.pb"
